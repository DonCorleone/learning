...
function testCollissionBetweenBalls() {
    var balles = balls;
...
function drawVectors(i, j) {
    ...
    drawSpeedVector(balles[i], 3, 100, 'blue');
    drawSpeedVector(balles[j], 3, 100, 'green');
}
...
function drawSpeedVector(balle, epaisseur, longueurEnPixels, color) {
    var x = balle.x;
    var y = balle.y;
