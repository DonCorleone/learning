...
var dateMessageInvalid = 'Birth date should be in the past';
...
window.addEventListener('load', function() {
	...
	// invalid characters %, &, $, ! that are forbidden.
...
function addLineToHTMLTable(contact) {
	var row, lastNameColumn, firstNameColumn, telColumn, birthDateColumn;
	...
	birthDateColumn = document.createElement('td');
	...
	birthDateColumn.innerHTML = contact.birthDate;
